...
nanoem.gui.keyframe.cut切り取り"
nanoem.gui.keyframe.end#終了)
nanoem.gui.keyframe.pasteペースト7
!nanoem.gui.keyframe.inverse-paste反転ペースト$
nanoem.gui.keyframe.remove削除#
nanoem.gui.keyframe.scale拡大$
nanoem.gui.keyframe.select選択.
...
!nanoem.gui.panel.accessory.ground地面)
nanoem.gui.panel.accessory.load読込+
nanoem.gui.panel.accessory.none(なし)2
"nanoem.gui.panel.accessory.opacity不透明度0
&nanoem.gui.panel.accessory.orientation回転-
#nanoem.gui.panel.accessory.register登録-
...
nanoem.gui.panel.bone.pasteペースト9
#nanoem.gui.panel.bone.inverse-paste反転ペースト2
(nanoem.gui.panel.bone.physics-simulation物理(
nanoem.gui.panel.bone.register登録&
nanoem.gui.panel.bone.rotate回転&
...
"nanoem.gui.panel.camera.fov.format視野角: %d*
nanoem.gui.panel.camera.reset	初期化*
...
1nanoem.gui.panel.interpolation.bone.translation.z移動(Z軸)>
.nanoem.gui.panel.interpolation.camera.distance視野距離6
)nanoem.gui.panel.interpolation.camera.fov	視野角;
1nanoem.gui.panel.interpolation.camera.orientation回転C
3nanoem.gui.panel.interpolation.camera.translation.x移動(X軸)C
3nanoem.gui.panel.interpolation.camera.translation.y移動(Y軸)C
...
nanoem.gui.panel.model.delete削除%
nanoem.gui.panel.model.load読込,
%nanoem.gui.panel.model.outside-parent外)
nanoem.gui.panel.model.register登録6
nanoem.gui.panel.model.shadowセルフシャドウ*
...
nanoem.gui.panel.morph.eyebrowまゆ1
'nanoem.gui.panel.morph.eyebrow.register登録'
nanoem.gui.panel.morph.lip	リップ-
#nanoem.gui.panel.morph.lip.register登録)
...
!nanoem.gui.panel.view.follow.bone	ボーン/
"nanoem.gui.panel.view.follow.model	モデル%
...
-nanoem.gui.viewport.parameter.camera.distance視野距離9
,nanoem.gui.viewport.parameter.camera.look-at	注視点0
#nanoem.gui.viewport.parameter.model	モデル9
/nanoem.gui.viewport.parameter.model.orientation回転9
/nanoem.gui.viewport.parameter.model.translation移動5
%nanoem.gui.window.interpolation.title補間曲線6
nanoem.gui.window.op.model外部親（モデル）M
(nanoem.gui.window.op.model.register.bone!ボーンキーフレーム登録<
)nanoem.gui.window.op.model.register.model外部親登録:
'nanoem.gui.window.op.model.subject.bone対象ボーン8
,nanoem.gui.window.op.model.subject.bone.none(なし)?
&nanoem.gui.window.op.model.target.bone接続先親ボーン7
+nanoem.gui.window.op.model.target.bone.none(なし)@
'nanoem.gui.window.op.model.target.model接続先親モデル8
,nanoem.gui.window.op.model.target.model.none(なし)a
3nanoem.gui.window.op.model.subject.bone.translation*対象ボーンの位置（自動計算）a
3nanoem.gui.window.op.model.subject.bone.orientation*対象ボーンの回転（自動計算）@
nanoem.gui.window.op.accessory外部親（アクセサリ）@
-nanoem.gui.window.op.accessory.register.model外部親登録@
*nanoem.gui.window.op.accessory.target.bone接続先ボーン;
/nanoem.gui.window.op.accessory.target.bone.none(なし)A
+nanoem.gui.window.op.accessory.target.model接続先モデル<
0nanoem.gui.window.op.accessory.target.model.none(地面):
'nanoem.gui.window.op.accessory.register外部親登録9
 nanoem.gui.window.op.self-shadowセルフシャドウ8
+nanoem.gui.window.op.self-shadow.mode.title	モード:
*nanoem.gui.window.op.self-shadow.mode.none（なし）P
+nanoem.gui.window.op.self-shadow.mode.type1!モード１（バランス型）P
+nanoem.gui.window.op.self-shadow.mode.type2!モード２（近接重視型）9
/nanoem.gui.window.op.self-shadow.distance.title距離8
+nanoem.gui.window.op.self-shadow.initialize	初期化3
)nanoem.gui.window.op.self-shadow.register登録E
&nanoem.gui.window.bone.parameter.title数値入力（ボーン）6
,nanoem.gui.window.bone.parameter.translation移動6
,nanoem.gui.window.bone.parameter.orientation回転G
(nanoem.gui.window.camera.parameter.title数値入力（カメラ）7
*nanoem.gui.window.camera.parameter.look-at	注視点2
(nanoem.gui.window.camera.parameter.angle角度;
+nanoem.gui.window.camera.parameter.distance視野距離@
'nanoem.gui.window.bone.correction.title補正（ボーン）7
-nanoem.gui.window.bone.correction.translation移動7
-nanoem.gui.window.bone.correction.orientation回転B
)nanoem.gui.window.camera.correction.title補正（カメラ）8
+nanoem.gui.window.camera.correction.look-at	注視点3
)nanoem.gui.window.camera.correction.angle角度<
,nanoem.gui.window.camera.correction.distance視野距離A
(nanoem.gui.window.morph.correction.title補正（モーフ）9
)nanoem.gui.window.morph.correction.weightウェイトD
(nanoem.gui.window.project.viewport.titleビューポート設定O
-nanoem.gui.window.project.viewport.size.title出力サイズ (幅 / 高さ)M
.nanoem.gui.window.project.viewport.size.presetプリセットから設定@
3nanoem.gui.window.project.viewport.size.preset.from	選択...A
.nanoem.gui.window.project.viewport.color.title出力背景色V
4nanoem.gui.window.project.viewport.transparent.title透過背景を有効にするY
.nanoem.gui.window.project.order.drawable.title'モデル・アクセサリの描画順H
/nanoem.gui.window.project.order.transform.titleモデルの変形順>
...
"nanoem.gui.window.model.edge.colorエッジ色1
!nanoem.gui.window.model.edge.sizeエッジ幅J
%nanoem.gui.window.model.edge.register!キーフレームを登録する9
&nanoem.gui.window.project.effect.titleエフェクト9
&nanoem.gui.window.project.effect.titleエフェクトG
.nanoem.gui.window.project.effect.tab.offscreenオフスクリーン7
...
6nanoem.gui.window.preference.global.color-format.rgba8RGBA8 (SDR)I
8nanoem.gui.window.preference.global.color-format.rgb10a2RGB10A2 (HDR)H
8nanoem.gui.window.preference.global.color-format.rgba16fRGBA16 (HDR)I
'nanoem.gui.window.preference.global.fps編集時フレームレート>
1nanoem.gui.window.preference.global.fps.unlimited	無制限4
*nanoem.gui.window.preference.global.fps.3030 FPS4
*nanoem.gui.window.preference.global.fps.6060 FPS<
,nanoem.gui.window.preference.global.fps.auto自動設定v
3nanoem.gui.window.preference.viewport.high-dpi.mode?起動時の高解像度ビューポートを有効にするかH
8nanoem.gui.window.preference.viewport.high-dpi.mode.auto自動設定K
;nanoem.gui.window.preference.viewport.high-dpi.mode.enabled常に有効L
<nanoem.gui.window.preference.viewport.high-dpi.mode.disabled常に無効{
8nanoem.gui.window.preference.global.editing-model.enable?モデル編集機能を有効にする（実験的な機能）I
3nanoem.gui.window.preference.global.analytics.titleアクセス解析\
4nanoem.gui.window.preference.global.analytics.enable$アクセス解析を有効にするd
3nanoem.gui.window.preference.global.analytics.reset-アクセス解析用の UUID をリセットh
7nanoem.gui.window.preference.global.crash-report.enable-クラッシュレポートを有効にする�
;nanoem.gui.window.preference.global.analytics.reset.cautionR※ 変更を反映するにはアプリケーションの再起動が必要ですb
.nanoem.gui.window.preference.global.sda.enable0モデル描画の負荷分散を有効にするL
6nanoem.gui.window.preference.global.system-informationシステム情報:
'nanoem.gui.window.preference.grid.title地面軸設定=
3nanoem.gui.window.preference.project.language.title言語?
5nanoem.gui.window.preference.project.language.english英語C
6nanoem.gui.window.preference.project.language.japanese	日本語J
+nanoem.gui.window.preference.grid.size.cell地面軸セルの大きさJ
...
+nanoem.gui.model.edit.material.name.english名称（英語）T
...
9nanoem.gui.model.edit.bone.affected-by-physics-simulation物理演算後計算B
...
*nanoem.gui.model.edit.morph.category.other	その他6
,nanoem.gui.model.edit.morph.category.unknown不明2
%nanoem.gui.model.edit.morph.type.bone	ボーン5
%nanoem.gui.model.edit.morph.type.flipフリップ6
&nanoem.gui.model.edit.morph.type.groupグループ;
(nanoem.gui.model.edit.morph.type.impulseインパルス3
)nanoem.gui.model.edit.morph.type.material材質;
(nanoem.gui.model.edit.morph.type.textureテクスチャ3
%nanoem.gui.model.edit.morph.type.uva1
拡張 UV13
%nanoem.gui.model.edit.morph.type.uva2
拡張 UV23
%nanoem.gui.model.edit.morph.type.uva3
拡張 UV33
...
.nanoem.gui.model.edit.rigid-body.name.japanese名称（日本語）C
-nanoem.gui.model.edit.rigid-body.name.english名称（英語）8
%nanoem.gui.model.edit.rigid-body.bone接続ボーンH
,nanoem.gui.model.edit.rigid-body.object-typeオブジェクト種別;
+nanoem.gui.model.edit.rigid-body.shape-type形状種別7
'nanoem.gui.model.edit.rigid-body.origin原点座標6
...
4nanoem.gui.model.edit.rigid-body.object-type.unknown不明6
/nanoem.gui.model.edit.rigid-body.shape-type.box箱C
3nanoem.gui.model.edit.rigid-body.shape-type.capsuleカプセル<
2nanoem.gui.model.edit.rigid-body.shape-type.sphere球体=
3nanoem.gui.model.edit.rigid-body.shape-type.unknown不明B
)nanoem.gui.model.edit.joint.name.japanese名称（日本語）>
(nanoem.gui.model.edit.joint.name.english名称（英語）<
(nanoem.gui.model.edit.joint.rigid-body.a接続剛体 (A)<
(nanoem.gui.model.edit.joint.rigid-body.b接続剛体 (B)2
"nanoem.gui.model.edit.joint.origin原点座標1
'nanoem.gui.model.edit.joint.orientation回転8
(nanoem.gui.model.edit.joint.linear.upper移動上限8
(nanoem.gui.model.edit.joint.linear.lower移動下限<
,nanoem.gui.model.edit.joint.linear.stiffness移動剛性9
)nanoem.gui.model.edit.joint.angular.upper回転上限9
)nanoem.gui.model.edit.joint.angular.lower回転下限=
-nanoem.gui.model.edit.joint.angular.stiffness回転剛性2
(nanoem.gui.model.edit.soft-body.material材質:
*nanoem.gui.model.edit.soft-body.shape-type形状種別I
3nanoem.gui.model.edit.soft-body.shape-type.tri-mesh三角メッシュ<
/nanoem.gui.model.edit.soft-body.shape-type.rope	ロープK
/nanoem.gui.model.edit.soft-body.aero-model-typeエアロモデル種別X
<nanoem.gui.model.edit.soft-body.aero-model-type.vertex-point頂点（ポイント）V
@nanoem.gui.model.edit.soft-body.aero-model-type.vertex-two-sided頂点（両面）V
@nanoem.gui.model.edit.soft-body.aero-model-type.vertex-one-sided頂点（片面）Q
>nanoem.gui.model.edit.soft-body.aero-model-type.face-two-sided面（両面）Q
>nanoem.gui.model.edit.soft-body.aero-model-type.face-one-sided面（方面）:
*nanoem.gui.model.edit.soft-body.total-mass合計質量F
0nanoem.gui.model.edit.soft-body.collision-margin衝突マージンJ
2nanoem.gui.model.edit.soft-body.collision-group-id衝突グループIDS
4nanoem.gui.model.edit.soft-body.collision-group-mask衝突グループマスクX
:nanoem.gui.model.edit.soft-body.velocity-correction-factorVelocity Correction FactorJ
3nanoem.gui.model.edit.soft-body.damping-coefficientDamping CoefficientD
0nanoem.gui.model.edit.soft-body.drag-coefficientDrag CoefficientD
0nanoem.gui.model.edit.soft-body.lift-coefficientLift CoefficientL
4nanoem.gui.model.edit.soft-body.pressure-coefficientPressure Coefficientb
?nanoem.gui.model.edit.soft-body.volume-conversation-coefficientVolume Conversation Coefficient\
<nanoem.gui.model.edit.soft-body.dynamic-friction-coefficientDynamic Friction CoefficientV
9nanoem.gui.model.edit.soft-body.pose-matching-coefficientPose Matching CoefficientP
6nanoem.gui.model.edit.soft-body.rigid-contact-hardnessRigid Contact HardnessT
8nanoem.gui.model.edit.soft-body.kinetic-contact-hardnessKinetic Contact HardnessN
5nanoem.gui.model.edit.soft-body.soft-contact-hardnessSoft Contact HardnessB
/nanoem.gui.model.edit.soft-body.anchor-hardnessAnchor HardnessT
8nanoem.gui.model.edit.soft-body.soft-vs-kinetic-hardnessSoft vs Kinetic HardnessP
6nanoem.gui.model.edit.soft-body.soft-vs-rigid-hardnessSoft vs Rigid HardnessN
5nanoem.gui.model.edit.soft-body.soft-vs-soft-hardnessSoft vs Soft Hardness^
=nanoem.gui.model.edit.soft-body.soft-vs-kinetic-impulse-splitSoft vs Kinetic Impulse SplitZ
;nanoem.gui.model.edit.soft-body.soft-vs-rigid-impulse-splitSoft vs Rigid Impulse SplitX
:nanoem.gui.model.edit.soft-body.soft-vs-soft-impulse-splitSoft vs Soft Impulse Split\
<nanoem.gui.model.edit.soft-body.linear-stiffness-coefficientLinear Stiffness Coefficient^
=nanoem.gui.model.edit.soft-body.angular-stiffness-coefficientAngular Stiffness Coefficient\
<nanoem.gui.model.edit.soft-body.volume-stiffness-coefficientVolume Stiffness Coefficient\
<nanoem.gui.model.edit.soft-body.bending-constraints-distanceBending Constraints Distance@
-nanoem.gui.model.edit.soft-body.cluster-countクラスタ数X
:nanoem.gui.model.edit.soft-body.velocity-solver-iterationsVelocity Solver IterationsX
:nanoem.gui.model.edit.soft-body.position-solver-iterationsPosition Solver IterationsR
7nanoem.gui.model.edit.soft-body.drift-solver-iterationsDrift Solver IterationsV
9nanoem.gui.model.edit.soft-body.cluster-solver-iterationsCluster Solver IterationsY
;nanoem.gui.model.edit.soft-body.bending-constraints-enabledEnable Bending ConstraintsR
0nanoem.gui.model.edit.soft-body.clusters-enabledクラスタを有効にする]
=nanoem.gui.model.edit.soft-body.randomize-constraints-enabledEnable Randomize Constraints(
nanoem.gui.model.editモデル編集*
 nanoem.gui.model.edit.info.title情報,
...
#nanoem.window.dialog.buttons.cancelキャンセル_
.nanoem.window.confirm-before-new-project.title-プロジェクトは変更されています�
0nanoem.window.confirm-before-new-project.messagec新しいプロジェクトを作成する前に現在のプロジェクトを保存しますか？`
/nanoem.window.confirm-before-open-project.title-プロジェクトは変更されています�
1nanoem.window.confirm-before-open-project.message]新しいプロジェクトを開く前に現在のプロジェクトを保存しますか？d
3nanoem.window.confirm-before-exit-application.title-プロジェクトは変更されています�
5nanoem.window.confirm-before-exit-application.message`アプリケーションを終了する前に現在のプロジェクトを保存しますか？c
2nanoem.window.confirm-before-exporting-image.title-プロジェクトは変更されています�
4nanoem.window.confirm-before-exporting-image.messageN画像を出力する前に現在のプロジェクトを保存しますか？c
2nanoem.window.confirm-before-exporting-video.title-プロジェクトは変更されています�
4nanoem.window.confirm-before-exporting-video.messageN動画を出力する前に現在のプロジェクトを保存しますか？C
*nanoem.window.confirm-editing-model.button編集機能有効化�
+nanoem.window.confirm-editing-model.messagef当該モデルの利用規約を確認済みの上でモデル編集機能を有効にしますか？T
)nanoem.window.confirm-editing-model.title'モデル編集機能有効化の確認8
"nanoem.window.dialog.capture-image画像出力設定8
"nanoem.window.dialog.capture-video動画出力設定�
4nanoem.window.dialog.capture-video.caution.exportingb* 出力中はアスペクト比が崩れることがありますが、終了後元に戻ります�
1nanoem.window.dialog.capture-video.caution.retina�* 高解像度モードで出力するとクラッシュする問題があるため、一度終了して Finder から「低解像度モードで開く」をチェックしてから出力してください�
...
1nanoem.window.dialog.enabling-effect-plugin.title0エフェクトプラグイン有効化の確認[
*nanoem.window.dialog.error.decoding.reason-音源または動画のデコードに失敗�
7nanoem.window.dialog.error.decoding.recovery-suggestion�別の音源または動画ファイルを指定するか、入力可能な音源または動画形式に変換してから指定してくださいO
*nanoem.window.dialog.error.encoding.reason!動画のエンコードに失敗�
7nanoem.window.dialog.error.encoding.recovery-suggestionZもう一度動画出力をやり直すか、別の動画形式で出力してください�
;nanoem.window.dialog.error.no-such-file.recovery-suggestion{%s が移動したことが原因かもしれません。ファイルを移動前のパスにコピーしてください。�
5nanoem.window.dialog.error.file-content-digest.reasonZ%s がプロジェクト保存時と違う内容となってるため読み込めませんo
)nanoem.window.dialog.error.message.reasonBエラーが発生しました。内容は以下のとおりですy
6nanoem.window.dialog.error.message.recovery-suggestion?以下の方法でエラーが解決するかもしれません3
 nanoem.window.dialog.error.titleエラー発生Z
'nanoem.window.dialog.redo.confirm.title/REDO ログファイルが見つかりました�
)nanoem.window.dialog.redo.confirm.message�前回のクラッシュによる REDO ログがあります。REDO ログからクラッシュ直前までのリカバリを行いますか？8
(nanoem.window.dialog.redo.progress.title作業中...`
*nanoem.window.dialog.redo.progress.message2REDO ログから作業状態をリカバリ中...`
*nanoem.window.dialog.redo.progress.message2REDO ログから作業状態をリカバリ中...>
+nanoem.window.dialog.export.resolution-size出力解像度J
(nanoem.window.dialog.export.sample-levelアンチエイリアス設定]
&nanoem.window.dialog.export.image.seek3現在のフレーム位置で画像を出力するQ
)nanoem.window.dialog.export.image.seek.at$画像出力するフレーム位置K
,nanoem.window.dialog.export.same-as-viewportビューポートと同じk
1nanoem.window.dialog.export.viewport-aspect-ratio6ビューポートのアスペクト比を維持するd
6nanoem.window.dialog.export.prevent-frame-misalighment*フレームズレ抑止を有効にするg
6nanoem.window.dialog.export.video.capture-video.native-OS 付属のエンコーダを有効にする@
'nanoem.window.dialog.export.audio.codec音声コーデック@
'nanoem.window.dialog.export.video.codec動画コーデックG
(nanoem.window.dialog.export.video.format動画のピクセル形式E
)nanoem.window.dialog.export.video.profile動画プロファイル7
'nanoem.window.dialog.export.video.range出力範囲)
nanoem.dialog.filename.untitled無題.
nanoem.dialog.capture.title動画出力中f
nanoem.dialog.capture.messageE動画出力中です。完了までしばらくお待ち下さい...F
!nanoem.dialog.progress.exit.title!アプリケーション終了中i
#nanoem.dialog.progress.exit.messageBアプリケーションが終了するまでお待ち下さい...=
!nanoem.dialog.progress.load.titleファイルを読込中Z
#nanoem.dialog.progress.load.message3ファイルの読込完了までお待ち下さい=
!nanoem.dialog.progress.save.titleファイルを保存中Z
#nanoem.dialog.progress.save.message3ファイルの保存完了までお待ち下さいO
!nanoem.dialog.progress.bake.title*モデルモーションの焼き込み中x
#nanoem.dialog.progress.bake.messageQ全てのモデルに対するモーションの焼き込みをしています...E
&nanoem.window.effect.%p.render-targetsレンダーターゲットc
/nanoem.window.effect.offscreen-render-target.%d0オフスクリーンレンダーターゲットD
...
nanoem.menu.project.msaa.x8高 (MSAAx8)1
nanoem.menu.project.msaa.x4やや高 (MSAAx4).
nanoem.menu.project.msaa.x2普通 (MSAAx2)+
!nanoem.menu.project.msaa.disabled無効@
nanoem.menu.project.msaa.titleアンチエイリアス設定E
5nanoem.menu.project.physics-simulation.enable.anytime常時有効H
5nanoem.menu.project.physics-simulation.enable.playing再生時のみN
5nanoem.menu.project.physics-simulation.enable.tracingトレースモード9
/nanoem.menu.project.physics-simulation.disabled無効D
4nanoem.menu.project.physics-simulation.configuration演算設定b
+nanoem.menu.project.physics-simulation.bake3全てのモデルのモーションを焼き込むr
,nanoem.menu.project.physics-simulation.bake2B全てのモデルのモーションを焼き込む（IK 含む）Q
;nanoem.menu.project.physics-simulation.enable.drawing.titleデバッグ描画O
?nanoem.menu.project.physics-simulation.enable.drawing.wireframeワイヤーB
:nanoem.menu.project.physics-simulation.enable.drawing.aabbAABBQ
Dnanoem.menu.project.physics-simulation.enable.drawing.contact-points	接続点]
Ananoem.menu.project.physics-simulation.enable.drawing.constraintsコンストレイントV
Fnanoem.menu.project.physics-simulation.enable.drawing.constraint-limit制約角度<
,nanoem.menu.project.physics-simulation.title物理演算.
!nanoem.menu.project.fps.unlimited	無制限#
nanoem.menu.project.fps.6060FPS#
nanoem.menu.project.fps.3030FPS?
nanoem.menu.project.fps.title再生時フレームレート2
nanoem.menu.project.clear.audio音源を消去8
nanoem.menu.project.clear.video背景動画を消去X
&nanoem.menu.project.enable.fps-counter.FPS カウンターの表示を有効にするn
.nanoem.menu.project.enable.performance-monitor<パフォーマンスモニターの表示を有効にする/
nanoem.menu.camera.toggleモードを切替'
nanoem.menu.camera.preset.top上面%
nanoem.menu.camera.preset.left左&
nanoem.menu.camera.preset.right右*
...
(nanoem.menu.model.select.morph.lip.title	リップ7
...
nanoem.menu.model.reset.bone.x X 軸の移動分をリセットB
nanoem.menu.model.reset.bone.y Y 軸の移動分をリセットB
nanoem.menu.model.reset.bone.z Z 軸の移動分をリセットD
...
2nanoem.menu.model.preference.enable.show-all-bones!全てのボーンを表示するN
5nanoem.menu.model.preference.enable.show-rigid-bodies剛体を表示するQ
/nanoem.menu.model.preference.enable.show-jointsジョイントを表示するT
5nanoem.menu.model.preference.enable.show-vertex-faces頂点の面を表示するU
...
nanoem.menu.edit.bone.bias*バイアス指定ダイアログを開くI
!nanoem.menu.edit.camera.parameter$数値入力ダイアログを開く<
#nanoem.menu.edit.camera.reset-angle角度をリセットD
"nanoem.menu.edit.camera.correction補正ダイアログを開くC
!nanoem.menu.edit.morph.correction補正ダイアログを開くZ
/nanoem.menu.edit.morph.remove-all-keyframes.lip'唇のキーフレームを全て削除Z
/nanoem.menu.edit.morph.remove-all-keyframes.eye'目のキーフレームを全て削除a
3nanoem.menu.edit.morph.remove-all-keyframes.eyebrow*まゆのキーフレームを全て削除L
...
nanoem.menu.macos.quitnanoem を終了.
!nanoem.menu.macos.window.minimize	最小化*
nanoem.menu.macos.window.zoom	ズームJ
+nanoem.menu.macos.window.bring-all-to-frontすべてを手前に移動(
...
/nanoem.error.convert-to-nmm.recovery-suggestion�メニューの「ヘルプ」にある「nanoem Online Manual」から「アプリケーションのメニュー」の「保存」の項目を参照してください�
 ...
 nanoem.error.project.save.reasonW不完全なデータが保存されようとしたため保存が中断されました�
-nanoem.error.project.save.recovery-suggestionQ保存先に異常がないかを確認してから再度保存してください�
0nanoem.error.plugin.model.no-active-model.reasonNプラグインの実行対象となるモデルが選択されていませんe
...
nanoem.status.ERROR_NULL_OBJECTNULL 参照がされましたI
nanoem.status.ERROR_BUFFER_END'バッファが終端に達してますp
0nanoem.status.ERROR_DECODE_UNICODE_STRING_FAILED<ユニコード文字列のデコードに失敗しましたs
0nanoem.status.ERROR_ENCODE_UNICODE_STRING_FAILED?ユニコード文字列のエンコードに失敗しましたG
%nanoem.status.ERROR_INVALID_SIGNATURE不正なシグネチャですI
*nanoem.status.ERROR_MODEL_VERTEX_CORRUPTED頂点が破損してます\
(nanoem.status.ERROR_MODEL_FACE_CORRUPTED0面（インデックス）が破損してますK
,nanoem.status.ERROR_MODEL_MATERIAL_CORRUPTED材質が破損してますJ
(nanoem.status.ERROR_MODEL_BONE_CORRUPTEDボーンが破損してますP
.nanoem.status.ERROR_MODEL_CONSTRAINT_CORRUPTEDIK 制約が破損してますY
+nanoem.status.ERROR_MODEL_TEXTURE_CORRUPTED*テクスチャ参照が破損してますK
)nanoem.status.ERROR_MODEL_MORPH_CORRUPTEDモーフが破損してますK
)nanoem.status.ERROR_MODEL_LABEL_CORRUPTED表示枠が破損してますM
.nanoem.status.ERROR_MODEL_RIGID_BODY_CORRUPTED剛体が破損してますQ
)nanoem.status.ERROR_MODEL_JOINT_CORRUPTED$ジョイントが破損してますU
)nanoem.status.ERROR_PMD_ENGLISH_CORRUPTED(PMD の英語情報が破損してますV
'nanoem.status.ERROR_PMX_INFO_CORRUPUTED+PMX のメタデータが破損してますi
2nanoem.status.ERROR_MOTION_BONE_KEYFRAME_CORRUPTED3ボーンのキーフレームが破損してますk
4nanoem.status.ERROR_MOTION_CAMERA_KEYFRAME_CORRUPTED3カメラのキーフレームが破損してますg
3nanoem.status.ERROR_MOTION_LIGHT_KEYFRAME_CORRUPTED0照明のキーフレームが破損してますj
3nanoem.status.ERROR_MOTION_MODEL_KEYFRAME_CORRUPTED3モデルのキーフレームが破損してますj
3nanoem.status.ERROR_MOTION_MORPH_KEYFRAME_CORRUPTED3モーフのキーフレームが破損してます|
9nanoem.status.ERROR_MOTION_SELF_SHADOW_KEYFRAME_CORRUPTED?セルフシャドウのキーフレームが破損してますz
7nanoem.status.ERROR_MOTION_BONE_KEYFRAME_ALREADY_EXISTS?ボーンのキーフレームがすでに存在していますi
2nanoem.status.ERROR_MOTION_BONE_KEYFRAME_NOT_FOUND3ボーンのキーフレームが存在しません|
9nanoem.status.ERROR_MOTION_CAMERA_KEYFRAME_ALREADY_EXISTS?カメラのキーフレームがすでに存在していますk
4nanoem.status.ERROR_MOTION_CAMERA_KEYFRAME_NOT_FOUND3カメラのキーフレームが存在しませんx
8nanoem.status.ERROR_MOTION_LIGHT_KEYFRAME_ALREADY_EXISTS<照明のキーフレームがすでに存在していますg
3nanoem.status.ERROR_MOTION_LIGHT_KEYFRAME_NOT_FOUND0照明のキーフレームが存在しませんr
/nanoem.status.ERROR_MOTION_FRAME_ALREADY_EXISTS?モデルのキーフレームがすでに存在していますj
3nanoem.status.ERROR_MOTION_MODEL_KEYFRAME_NOT_FOUND3モデルのキーフレームが存在しません{
8nanoem.status.ERROR_MOTION_MORPH_KEYFRAME_ALREADY_EXISTS?モーフのキーフレームがすでに存在していますj
3nanoem.status.ERROR_MOTION_MORPH_KEYFRAME_NOT_FOUND3モーフのキーフレームが存在しません�
>nanoem.status.ERROR_MOTION_SELF_SHADOW_KEYFRAME_ALREADY_EXISTSKセルフシャドウのキーフレームがすでに存在しています|
9nanoem.status.ERROR_MOTION_SELF_SHADOW_KEYFRAME_NOT_FOUND?セルフシャドウのキーフレームが存在しません�
<nanoem.status.ERROR_MOTION_ACCESSORY_KEYFRAME_ALREADY_EXISTSEアクセサリのキーフレームがすでに存在していますt
7nanoem.status.ERROR_MOTION_ACCESSORY_KEYFRAME_NOT_FOUND9アクセサリのキーフレームが存在しません�
3nanoem.status.ERROR_EFFECT_PARAMETER_ALREADY_EXISTSTエフェクトパラメータのキーフレームがすでに存在していますz
.nanoem.status.ERROR_EFFECT_PARAMETER_NOT_FOUNDHエフェクトパラメータのキーフレームが存在しませんs
9nanoem.status.ERROR_MODEL_CONSTRAINT_STATE_ALREADY_EXISTS6IK キーフレームがすでに存在していますb
4nanoem.status.ERROR_MODEL_CONSTRAINT_STATE_NOT_FOUND*IK キーフレームが存在しませんy
0nanoem.status.ERROR_MODEL_BINDING_ALREADY_EXISTSE外部親モデルキーフレームがすでに存在していますh
+nanoem.status.ERROR_MODEL_BINDING_NOT_FOUND9外部親モデルキーフレームが存在しませんZ
/nanoem.status.ERROR_MODEL_VERTEX_ALREADY_EXISTS'頂点がすでに存在していますI
*nanoem.status.ERROR_MODEL_VERTEX_NOT_FOUND頂点が存在しません\
1nanoem.status.ERROR_MODEL_MATERIAL_ALREADY_EXISTS'材質がすでに存在していますK
,nanoem.status.ERROR_MODEL_MATERIAL_NOT_FOUND材質が存在しませんO
-nanoem.status.ERROR_MODEL_BONE_ALREADY_EXISTSボーンが存在しませんJ
(nanoem.status.ERROR_MODEL_BONE_NOT_FOUNDボーンが存在しませんU
3nanoem.status.ERROR_MODEL_CONSTRAINT_ALREADY_EXISTSIK 制約が存在しませんP
.nanoem.status.ERROR_MODEL_CONSTRAINT_NOT_FOUNDIK 制約が存在しませんb
4nanoem.status.ERROR_MODEL_CONSTRAINT_JOINT_NOT_FOUND*IK 制約のボーンが存在しませんj
0nanoem.status.ERROR_MODEL_TEXTURE_ALREADY_EXISTS6テクスチャ参照がすでに存在していますY
+nanoem.status.ERROR_MODEL_TEXTURE_NOT_FOUND*テクスチャ参照が存在しません\
.nanoem.status.ERROR_MODEL_MORPH_ALREADY_EXISTS*モーフがすでに存在していますK
)nanoem.status.ERROR_MODEL_MORPH_NOT_FOUNDモーフが存在しませんU
-nanoem.status.ERROR_MODEL_MORPH_TYPE_MISMATCH$モーフ種別が一致しません_
.nanoem.status.ERROR_MODEL_MORPH_BONE_NOT_FOUND-モーフ（ボーン）が存在しませんb
.nanoem.status.ERROR_MODEL_MORPH_FLIP_NOT_FOUND0モーフ（フリップ）が存在しませんc
/nanoem.status.ERROR_MODEL_MORPH_GROUP_NOT_FOUND0モーフ（グループ）が存在しませんh
1nanoem.status.ERROR_MODEL_MORPH_IMPULSE_NOT_FOUND3モーフ（インパルス）が存在しません`
2nanoem.status.ERROR_MODEL_MORPH_MATERIAL_NOT_FOUND*モーフ（材質）が存在しませんV
,nanoem.status.ERROR_MODEL_MORPH_UV_NOT_FOUND&モーフ（UV）が存在しません^
0nanoem.status.ERROR_MODEL_MORPH_VERTEX_NOT_FOUND*モーフ（頂点）が存在しません\
.nanoem.status.ERROR_MODEL_LABEL_ALREADY_EXISTS*表示枠がすでに存在していますK
)nanoem.status.ERROR_MODEL_LABEL_NOT_FOUND表示枠が存在しませんY
.nanoem.status.ERROR_MODEL_LABEL_ITEM_NOT_FOUND'表示枠の中身が存在しません^
3nanoem.status.ERROR_MODEL_RIGID_BODY_ALREADY_EXISTS'剛体がすでに存在していますM
.nanoem.status.ERROR_MODEL_RIGID_BODY_NOT_FOUND剛体が存在しませんb
.nanoem.status.ERROR_MODEL_JOINT_ALREADY_EXISTS0ジョイントがすでに存在していますQ
)nanoem.status.ERROR_MODEL_JOINT_NOT_FOUND$ジョイントが存在しません_
.nanoem.status.ERROR_MODEL_VERSION_INCOMPATIBLE-モデルのバージョンが非互換ですi
5nanoem.status.ERROR_DOCUMENT_ACCESSORY_ALREADY_EXISTS0アクセサリがすでに存在していますX
0nanoem.status.ERROR_DOCUMENT_ACCESSORY_NOT_FOUND$アクセサリが存在しません�
>nanoem.status.ERROR_DOCUMENT_ACCESSORY_KEYFRAME_ALREADY_EXISTSEアクセサリのキーフレームがすでに存在していますv
9nanoem.status.ERROR_DOCUMENT_ACCESSORY_KEYFRAME_NOT_FOUND9アクセサリのキーフレームが存在しません~
;nanoem.status.ERROR_DOCUMENT_CAMERA_KEYFRAME_ALREADY_EXISTS?カメラのキーフレームがすでに存在していますm
6nanoem.status.ERROR_DOCUMENT_CAMERA_KEYFRAME_NOT_FOUND3カメラのキーフレームが存在しません�
<nanoem.status.ERROR_DOCUMENT_GRAVITY_KEYFRAME_ALREADY_EXISTSB物理演算のキーフレームがすでに存在していますq
7nanoem.status.ERROR_DOCUMENT_GRAVITY_KEYFRAME_NOT_FOUND6物理演算のキーフレームが存在しませんz
:nanoem.status.ERROR_DOCUMENT_LIGHT_KEYFRAME_ALREADY_EXISTS<照明のキーフレームがすでに存在していますi
5nanoem.status.ERROR_DOCUMENT_LIGHT_KEYFRAME_NOT_FOUND0照明のキーフレームが存在しません_
1nanoem.status.ERROR_DOCUMENT_MODEL_ALREADY_EXISTS*モデルがすでに存在していますN
,nanoem.status.ERROR_DOCUMENT_MODEL_NOT_FOUNDモデルが存在しません�
?nanoem.status.ERROR_DOCUMENT_MODEL_BONE_KEYFRAME_ALREADY_EXISTS?ボーンのキーフレームがすでに存在していますq
:nanoem.status.ERROR_DOCUMENT_MODEL_BONE_KEYFRAME_NOT_FOUND3ボーンのキーフレームが存在しませんs
<nanoem.status.ERROR_DOCUMENT_MODEL_BONE_STATE_ALREADY_EXISTS3ボーンの状態がすでに存在していますb
7nanoem.status.ERROR_DOCUMENT_MODEL_BONE_STATE_NOT_FOUND'ボーンの状態が存在しません|
Bnanoem.status.ERROR_DOCUMENT_MODEL_CONSTRAINT_STATE_ALREADY_EXISTS6IK ボーンの状態がすでに存在していますk
=nanoem.status.ERROR_DOCUMENT_MODEL_CONSTRAINT_STATE_NOT_FOUND*IK ボーンの状態が存在しません�
@nanoem.status.ERROR_DOCUMENT_MODEL_MODEL_KEYFRAME_ALREADY_EXISTS?モーフのキーフレームがすでに存在していますr
;nanoem.status.ERROR_DOCUMENT_MODEL_MODEL_KEYFRAME_NOT_FOUND3モデルのキーフレームが存在しません�
@nanoem.status.ERROR_DOCUMENT_MODEL_MORPH_KEYFRAME_ALREADY_EXISTS?モーフのキーフレームがすでに存在していますr
;nanoem.status.ERROR_DOCUMENT_MODEL_MORPH_KEYFRAME_NOT_FOUND3モーフのキーフレームが存在しませんt
=nanoem.status.ERROR_DOCUMENT_MODEL_MORPH_STATE_ALREADY_EXISTS3モーフの状態がすでに存在していますc
8nanoem.status.ERROR_DOCUMENT_MODEL_MORPH_STATE_NOT_FOUND'モーフの状態が存在しませんz
@nanoem.status.ERROR_DOCUMENT_MODEL_OUTSIDE_PARENT_ALREADY_EXISTS6モデルの外部親がすでに存在していますi
;nanoem.status.ERROR_DOCUMENT_MODEL_OUTSIDE_PARENT_NOT_FOUND*モーフの外部親が存在しません�
Fnanoem.status.ERROR_DOCUMENT_MODEL_OUTSIDE_PARENT_STATE_ALREADY_EXISTS?モデルの外部親の状態がすでに存在していますx
Ananoem.status.ERROR_DOCUMENT_MODEL_OUTSIDE_PARENT_STATE_NOT_FOUND3モーフの外部親の状態が存在しません�
@nanoem.status.ERROR_DOCUMENT_SELF_SHADOW_KEYFRAME_ALREADY_EXISTSKセルフシャドウのキーフレームがすでに存在しています~
;nanoem.status.ERROR_DOCUMENT_SELF_SHADOW_KEYFRAME_NOT_FOUND?セルフシャドウのキーフレームが存在しませんd
0nanoem.status.ERROR_DOCUMENT_ACCESSORY_CORRUPTED0アクセサリデータが破損していますy
9nanoem.status.ERROR_DOCUMENT_ACCESSORY_KEYFRAME_CORRUPTED<アクセサリのキーフレームが破損していますv
?nanoem.status.ERROR_DOCUMENT_ACCESSORY_OUTSIDE_PARENT_CORRUPTED3アクセサリの外部親が破損しています[
-nanoem.status.ERROR_DOCUMENT_CAMERA_CORRUPTED*カメラデータが破損していますp
6nanoem.status.ERROR_DOCUMENT_CAMERA_KEYFRAME_CORRUPTED6カメラのキーフレームが破損しています_
.nanoem.status.ERROR_DOCUMENT_GRAVITY_CORRUPTED-物理演算データが破損していますt
7nanoem.status.ERROR_DOCUMENT_GRAVITY_KEYFRAME_CORRUPTED9物理演算のキーフレームが破損していますW
,nanoem.status.ERROR_DOCUMENT_LIGHT_CORRUPTED'照明データが破損していますl
5nanoem.status.ERROR_DOCUMENT_LIGHT_KEYFRAME_CORRUPTED3照明のキーフレームが破損していますZ
,nanoem.status.ERROR_DOCUMENT_MODEL_CORRUPTED*モデルデータが破損していますo
5nanoem.status.ERROR_DOCUMENT_MODEL_KEYFRAME_CORRUPTED6モデルのキーフレームが破損していますt
:nanoem.status.ERROR_DOCUMENT_MODEL_BONE_KEYFRAME_CORRUPTED6ボーンのキーフレームが破損していますe
7nanoem.status.ERROR_DOCUMENT_MODEL_BONE_STATE_CORRUPTED*ボーンの状態が破損していますn
=nanoem.status.ERROR_DOCUMENT_MODEL_CONSTRAINT_STATE_CORRUPTED-IK ボーンの状態が破損していますu
;nanoem.status.ERROR_DOCUMENT_MODEL_MORPH_KEYFRAME_CORRUPTED6モーフのキーフレームが破損していますf
8nanoem.status.ERROR_DOCUMENT_MODEL_MORPH_STATE_CORRUPTED*モーフの状態が破損していますl
...
nanoem.gui.keyframe.cutCut
nanoem.gui.keyframe.end#End"
nanoem.gui.keyframe.pastePaste,
!nanoem.gui.keyframe.inverse-pasteI-Paste$
nanoem.gui.keyframe.removeRemove"
nanoem.gui.keyframe.scaleScale$
nanoem.gui.keyframe.selectSelect+
...
!nanoem.gui.panel.accessory.groundGround'
nanoem.gui.panel.accessory.loadLoad)
nanoem.gui.panel.accessory.none(none)-
"nanoem.gui.panel.accessory.opacityOpacity5
&nanoem.gui.panel.accessory.orientationOrientation/
#nanoem.gui.panel.accessory.registerRegister)
...
nanoem.gui.panel.bone.pastePaste.
#nanoem.gui.panel.bone.inverse-pasteI-Paste3
(nanoem.gui.panel.bone.physics-simulationPhysics*
nanoem.gui.panel.bone.registerRegister&
nanoem.gui.panel.bone.rotateRotate&
...
"nanoem.gui.panel.camera.fov.formatFov: %d+
nanoem.gui.panel.camera.reset
Initialize'
...
1nanoem.gui.panel.interpolation.bone.translation.yTranslation (Y-Axis)I
1nanoem.gui.panel.interpolation.bone.translation.zTranslation (Z-Axis):
.nanoem.gui.panel.interpolation.camera.distanceDistance0
)nanoem.gui.panel.interpolation.camera.fovFov@
1nanoem.gui.panel.interpolation.camera.orientationOrientationK
3nanoem.gui.panel.interpolation.camera.translation.xTranslation (X-Axis)K
3nanoem.gui.panel.interpolation.camera.translation.yTranslation (Y-Axis)K
...
nanoem.gui.panel.model.deleteDelete#
nanoem.gui.panel.model.loadLoad+
%nanoem.gui.panel.model.outside-parentOP+
nanoem.gui.panel.model.registerRegister,
nanoem.gui.panel.model.shadowSelf Shadow(
...
nanoem.gui.panel.morph.eyebrowEyebrow3
'nanoem.gui.panel.morph.eyebrow.registerRegister!
nanoem.gui.panel.morph.lipLip/
#nanoem.gui.panel.morph.lip.registerRegister%
...
nanoem.gui.panel.play.playPlay&
...
!nanoem.gui.panel.view.follow.boneBone+
"nanoem.gui.panel.view.follow.modelModel$
...
-nanoem.gui.viewport.parameter.camera.distanceDistance6
,nanoem.gui.viewport.parameter.camera.look-atLookAt,
#nanoem.gui.viewport.parameter.modelModel>
/nanoem.gui.viewport.parameter.model.orientationOrientation>
/nanoem.gui.viewport.parameter.model.translationTranslation<
%nanoem.gui.window.interpolation.titleInterpolation Curve4
nanoem.gui.window.op.modelOutside Parent (Model)B
(nanoem.gui.window.op.model.register.boneRegister Bone KeyframeD
)nanoem.gui.window.op.model.register.modelRegister Outside Parent7
'nanoem.gui.window.op.model.subject.boneSubject Bone6
,nanoem.gui.window.op.model.subject.bone.none(none);
&nanoem.gui.window.op.model.target.boneTarget Model Bone5
+nanoem.gui.window.op.model.target.bone.none(none)7
'nanoem.gui.window.op.model.target.modelTarget Model6
,nanoem.gui.window.op.model.target.model.none(none)^
3nanoem.gui.window.op.model.subject.bone.translation'Subject Bone's Translation (Calculated)^
3nanoem.gui.window.op.model.subject.bone.orientation'Subject Bone's Orientation (Calculated)<
nanoem.gui.window.op.accessoryOutside Parent (Accessory)H
-nanoem.gui.window.op.accessory.register.modelRegister Outside Parent?
*nanoem.gui.window.op.accessory.target.boneTarget Model Bone9
/nanoem.gui.window.op.accessory.target.bone.none(None);
+nanoem.gui.window.op.accessory.target.modelTarget Model<
0nanoem.gui.window.op.accessory.target.model.none(Ground)B
'nanoem.gui.window.op.accessory.registerRegister Outside Parent/
 nanoem.gui.window.op.self-shadowSelf Shadow3
+nanoem.gui.window.op.self-shadow.mode.titleMode4
*nanoem.gui.window.op.self-shadow.mode.none(None)@
+nanoem.gui.window.op.self-shadow.mode.type1Mode 1 (Balanced)O
+nanoem.gui.window.op.self-shadow.mode.type2 Mode 2 (Better for Near Objects);
/nanoem.gui.window.op.self-shadow.distance.titleDistance9
+nanoem.gui.window.op.self-shadow.initialize
Initialize5
)nanoem.gui.window.op.self-shadow.registerRegister<
&nanoem.gui.window.bone.parameter.titleBone Numeric Input;
,nanoem.gui.window.bone.parameter.translationTranslation;
,nanoem.gui.window.bone.parameter.orientationOrientation@
(nanoem.gui.window.camera.parameter.titleCamera Numeric Input4
*nanoem.gui.window.camera.parameter.look-atLookAt1
(nanoem.gui.window.camera.parameter.angleAngle7
+nanoem.gui.window.camera.parameter.distanceDistance:
'nanoem.gui.window.bone.correction.titleBone Correction<
-nanoem.gui.window.bone.correction.translationTranslation<
-nanoem.gui.window.bone.correction.orientationOrientation>
)nanoem.gui.window.camera.correction.titleCamera Correction5
+nanoem.gui.window.camera.correction.look-atLookAt2
)nanoem.gui.window.camera.correction.angleAngle8
,nanoem.gui.window.camera.correction.distanceDistance<
(nanoem.gui.window.morph.correction.titleMorph Correction3
)nanoem.gui.window.morph.correction.weightWeight<
(nanoem.gui.window.project.viewport.titleViewport SettingM
-nanoem.gui.window.project.viewport.size.titleOutput Size (Width / Height)A
.nanoem.gui.window.project.viewport.size.presetSet from PresetF
3nanoem.gui.window.project.viewport.size.preset.fromSelect from ...I
.nanoem.gui.window.project.viewport.color.titleOutput Background ColorU
4nanoem.gui.window.project.viewport.transparent.titleEnable Transparent BackgroundO
.nanoem.gui.window.project.order.drawable.titleDrawing Model/Accessory OrderH
/nanoem.gui.window.project.order.transform.titleTransform Model OrderD
...
"nanoem.gui.window.model.edge.colorColor*
!nanoem.gui.window.model.edge.sizeWidth:
%nanoem.gui.window.model.edge.registerRegister Keyframe0
&nanoem.gui.window.project.effect.titleEffect0
&nanoem.gui.window.project.effect.titleEffect;
.nanoem.gui.window.project.effect.tab.offscreen	Offscreen3
...
$nanoem.gui.window.model.tab.materialMaterial(
 nanoem.gui.window.model.tab.boneBone*
!nanoem.gui.window.model.tab.morphMorph*
!nanoem.gui.window.model.tab.labelLabel4
...
6nanoem.gui.window.preference.global.color-format.rgba8RGBA8 (SDR)I
8nanoem.gui.window.preference.global.color-format.rgb10a2RGB10A2 (HDR)H
8nanoem.gui.window.preference.global.color-format.rgba16fRGBA16 (HDR)@
'nanoem.gui.window.preference.global.fpsFrame Rate at Editing>
1nanoem.gui.window.preference.global.fps.unlimited	Unlimited4
*nanoem.gui.window.preference.global.fps.3030 FPS4
*nanoem.gui.window.preference.global.fps.6060 FPS9
,nanoem.gui.window.preference.global.fps.auto	AutomaticZ
3nanoem.gui.window.preference.viewport.high-dpi.mode#Enable High-DPI Viewport at StartupE
8nanoem.gui.window.preference.viewport.high-dpi.mode.auto	AutomaticM
;nanoem.gui.window.preference.viewport.high-dpi.mode.enabledAlways EnabledO
<nanoem.gui.window.preference.viewport.high-dpi.mode.disabledAlways Disabledg
8nanoem.gui.window.preference.global.editing-model.enable+Enable Model Editing (Experimental Feature)@
3nanoem.gui.window.preference.global.analytics.title	AnalyticsQ
4nanoem.gui.window.preference.global.analytics.enableEnable Analytics TrackingK
3nanoem.gui.window.preference.global.analytics.resetReset Analytics UUIDN
7nanoem.gui.window.preference.global.crash-report.enableEnable Crash Reportq
;nanoem.gui.window.preference.global.analytics.reset.caution2* Restarting application required to apply changesX
.nanoem.gui.window.preference.global.sda.enable&Enable Load Balancing of Drawing ModelL
6nanoem.gui.window.preference.global.system-informationSystem Information=
'nanoem.gui.window.preference.grid.titleGrid Configuration?
3nanoem.gui.window.preference.project.language.titleLanguage@
5nanoem.gui.window.preference.project.language.englishEnglishA
6nanoem.gui.window.preference.project.language.japaneseJapanse8
+nanoem.gui.window.preference.grid.size.cell	Cell Size=
...
,nanoem.gui.model.edit.material.name.japaneseName (Japanese)=
+nanoem.gui.model.edit.material.name.englishName (English)=
,nanoem.gui.model.edit.material.ambient.colorAmbient Color=
...
%nanoem.gui.model.edit.bone.rotateable
Rotateable-
...
)nanoem.gui.model.edit.bone.inherent.localLocal Inherent[
9nanoem.gui.model.edit.bone.affected-by-physics-simulationAffected by Physics Simulation<
...
*nanoem.gui.model.edit.morph.category.otherOther7
,nanoem.gui.model.edit.morph.category.unknownUnknown-
%nanoem.gui.model.edit.morph.type.boneBone-
%nanoem.gui.model.edit.morph.type.flipFlip/
&nanoem.gui.model.edit.morph.type.groupGroup3
(nanoem.gui.model.edit.morph.type.impulseImpulse5
)nanoem.gui.model.edit.morph.type.materialMaterial3
(nanoem.gui.model.edit.morph.type.textureTexture7
%nanoem.gui.model.edit.morph.type.uva1Additional UV17
%nanoem.gui.model.edit.morph.type.uva2Additional UV27
...
.nanoem.gui.model.edit.rigid-body.name.japaneseName (Japanese)?
-nanoem.gui.model.edit.rigid-body.name.englishName (English)-
%nanoem.gui.model.edit.rigid-body.boneBone;
,nanoem.gui.model.edit.rigid-body.object-typeObject Type9
+nanoem.gui.model.edit.rigid-body.shape-type
Shape Type1
'nanoem.gui.model.edit.rigid-body.originOrigin;
,nanoem.gui.model.edit.rigid-body.orientationOrientation9
+nanoem.gui.model.edit.rigid-body.shape.size
Shape Size-
%nanoem.gui.model.edit.rigid-body.massMassA
...
4nanoem.gui.model.edit.rigid-body.object-type.unknownUnknown6
/nanoem.gui.model.edit.rigid-body.shape-type.boxBox>
3nanoem.gui.model.edit.rigid-body.shape-type.capsuleCapsule<
2nanoem.gui.model.edit.rigid-body.shape-type.sphereSphere>
3nanoem.gui.model.edit.rigid-body.shape-type.unknownUnknown<
)nanoem.gui.model.edit.joint.name.japaneseName (Japanese):
(nanoem.gui.model.edit.joint.name.englishName (English)D
(nanoem.gui.model.edit.joint.rigid-body.aConnected Rigid Body (A)D
(nanoem.gui.model.edit.joint.rigid-body.bConnected Rigid Body (B),
"nanoem.gui.model.edit.joint.originOrigin6
'nanoem.gui.model.edit.joint.orientationOrientation8
(nanoem.gui.model.edit.joint.linear.upperLinear Upper8
(nanoem.gui.model.edit.joint.linear.lowerLinear Lower@
,nanoem.gui.model.edit.joint.linear.stiffnessLinear Stiffness:
)nanoem.gui.model.edit.joint.angular.upperAngular Upper:
)nanoem.gui.model.edit.joint.angular.lowerAngular LowerB
-nanoem.gui.model.edit.joint.angular.stiffnessAngular Stiffness4
(nanoem.gui.model.edit.soft-body.materialMaterial8
*nanoem.gui.model.edit.soft-body.shape-type
Shape TypeF
3nanoem.gui.model.edit.soft-body.shape-type.tri-meshTriangle Meshes7
/nanoem.gui.model.edit.soft-body.shape-type.ropeRopeB
/nanoem.gui.model.edit.soft-body.aero-model-typeAero Model TypeN
<nanoem.gui.model.edit.soft-body.aero-model-type.vertex-pointVertex (Point)U
@nanoem.gui.model.edit.soft-body.aero-model-type.vertex-two-sidedVertex (Two Side)U
@nanoem.gui.model.edit.soft-body.aero-model-type.vertex-one-sidedVertex (One Side)Q
>nanoem.gui.model.edit.soft-body.aero-model-type.face-two-sidedFace (Two Side)Q
>nanoem.gui.model.edit.soft-body.aero-model-type.face-one-sidedFace (One Side)8
*nanoem.gui.model.edit.soft-body.total-mass
Total MassD
0nanoem.gui.model.edit.soft-body.collision-marginCollision MarginH
2nanoem.gui.model.edit.soft-body.collision-group-idCollision Group IDL
4nanoem.gui.model.edit.soft-body.collision-group-maskCollision Group MaskX
:nanoem.gui.model.edit.soft-body.velocity-correction-factorVelocity Correction FactorJ
3nanoem.gui.model.edit.soft-body.damping-coefficientDamping CoefficientD
0nanoem.gui.model.edit.soft-body.drag-coefficientDrag CoefficientD
0nanoem.gui.model.edit.soft-body.lift-coefficientLift CoefficientL
...
<nanoem.gui.model.edit.soft-body.volume-stiffness-coefficientVolume Stiffness Coefficient\
<nanoem.gui.model.edit.soft-body.bending-constraints-distanceBending Constraints Distance>
-nanoem.gui.model.edit.soft-body.cluster-countCluster CountX
:nanoem.gui.model.edit.soft-body.velocity-solver-iterationsVelocity Solver IterationsX
:nanoem.gui.model.edit.soft-body.position-solver-iterationsPosition Solver IterationsR
7nanoem.gui.model.edit.soft-body.drift-solver-iterationsDrift Solver IterationsV
9nanoem.gui.model.edit.soft-body.cluster-solver-iterationsCluster Solver IterationsY
;nanoem.gui.model.edit.soft-body.bending-constraints-enabledEnable Bending ConstraintsB
0nanoem.gui.model.edit.soft-body.clusters-enabledEnable Cluster]
=nanoem.gui.model.edit.soft-body.randomize-constraints-enabledEnable Randomize Constraints#
nanoem.gui.model.edit
Model Edit(
 nanoem.gui.model.edit.info.titleInfo,
"nanoem.gui.model.edit.vertex.titleVertex0
$nanoem.gui.model.edit.material.titleMateiral(
 nanoem.gui.model.edit.bone.titleBone*
!nanoem.gui.model.edit.morph.titleMorph*
!nanoem.gui.model.edit.label.titleLabel4
&nanoem.gui.model.edit.rigid-body.title
Rigid Body*
...
#nanoem.window.dialog.buttons.cancelCancelI
.nanoem.window.confirm-before-new-project.titleThe project is modifiedz
0nanoem.window.confirm-before-new-project.messageFDo you want to save the current project before creating a new project?J
/nanoem.window.confirm-before-open-project.titleThe project is modifiedx
1nanoem.window.confirm-before-open-project.messageCDo you want to save the current project before opening the project?N
3nanoem.window.confirm-before-exit-application.titleThe project is modified�
5nanoem.window.confirm-before-exit-application.messageGDo you want to save the current project before exiting the application?M
2nanoem.window.confirm-before-exporting-image.titleThe project is modified{
4nanoem.window.confirm-before-exporting-image.messageCDo you want to save the current project before exporting the image?M
2nanoem.window.confirm-before-exporting-video.titleThe project is modified{
4nanoem.window.confirm-before-exporting-video.messageCDo you want to save the current project before exporting the video?<
*nanoem.window.confirm-editing-model.buttonEnable Editing_
+nanoem.window.confirm-editing-model.message0Do you want to enable editing the model feature?K
)nanoem.window.confirm-editing-model.titleConfirm Enabling Editing Model>
"nanoem.window.dialog.capture-imageCapturing Image Settings>
"nanoem.window.dialog.capture-videoCapturing Video Settingsv
4nanoem.window.dialog.capture-video.caution.exporting>* The aspect ratio may break while capturing video is running.�
1nanoem.window.dialog.capture-video.caution.retina�* Due to application crash at capturing video issue, Quit this application and check `Open in Low-Resolution` from Finder and restart the application.q
...
1nanoem.window.dialog.enabling-effect-plugin.titleConfirm Enabling Effect PluginI
*nanoem.window.dialog.error.decoding.reasonFailed Decoding Audio/Video�
7nanoem.window.dialog.error.decoding.recovery-suggestionYSpecify another audio/video file or convert the audio/video file to the decodable format.C
*nanoem.window.dialog.error.encoding.reasonFailed Encoding Videot
7nanoem.window.dialog.error.encoding.recovery-suggestion9Retry encoding the video or specify another video format.�
;nanoem.window.dialog.error.no-such-file.recovery-suggestion_This issue may cause due to "%s" has been moved. Copy the file to the path before it was moved.�
5nanoem.window.dialog.error.file-content-digest.reasonYThe file %s cannot be loaded due to difference of the file content at saving the project._
)nanoem.window.dialog.error.message.reason2The error has been occurred. It's reason is below.d
6nanoem.window.dialog.error.message.recovery-suggestion*The error may solve following instruction.*
 nanoem.window.dialog.error.titleError!A
'nanoem.window.dialog.redo.confirm.titleRedo log file is found�
)nanoem.window.dialog.redo.confirm.messageoThe last redo log file is found due to last application crash. Do you want to recover workspace from redo file??
(nanoem.window.dialog.redo.progress.titleWork in progress...P
*nanoem.window.dialog.redo.progress.message"Recover workspace from redo log...P
*nanoem.window.dialog.redo.progress.message"Recover workspace from redo log...@
+nanoem.window.dialog.export.resolution-sizeOutput ResolutionC
(nanoem.window.dialog.export.sample-levelAntialias ConfigurationG
&nanoem.window.dialog.export.image.seekExport Image at Current Frame<
)nanoem.window.dialog.export.image.seek.atExport Image at@
,nanoem.window.dialog.export.same-as-viewportSame as ViewportO
1nanoem.window.dialog.export.viewport-aspect-ratioKeep Viewport Aspect Ratio^
6nanoem.window.dialog.export.prevent-frame-misalighment$Enable Preventing Frame MisalighmentM
6nanoem.window.dialog.export.video.capture-video.nativeEnable OS's Encoder6
'nanoem.window.dialog.export.audio.codecAudio Codec6
'nanoem.window.dialog.export.video.codecVideo Codec>
(nanoem.window.dialog.export.video.formatVideo Pixel Format:
)nanoem.window.dialog.export.video.profileVideo Profile:
'nanoem.window.dialog.export.video.rangeExporting Range+
nanoem.dialog.filename.untitledUntitled.
nanoem.dialog.capture.titleExporting VideoJ
nanoem.dialog.capture.message)Exporting the video, wait for a moment...8
!nanoem.dialog.progress.exit.titleExiting ApplicationI
#nanoem.dialog.progress.exit.message"Waiting for exiting application...1
!nanoem.dialog.progress.load.titleLoading FileC
#nanoem.dialog.progress.load.messageWaiting for loading the file0
!nanoem.dialog.progress.save.titleSaving FileB
#nanoem.dialog.progress.save.messageWaiting for saving the file9
!nanoem.dialog.progress.bake.titleBaking Model MotionsJ
#nanoem.dialog.progress.bake.message#Perform baking all model motions...7
&nanoem.window.effect.%p.render-targetsRender TargetJ
/nanoem.window.effect.offscreen-render-target.%dOffscreen Render Target6
...
nanoem.menu.project.msaa.x8High (MSAAx8)3
nanoem.menu.project.msaa.x4Little High (MSAAx4).
nanoem.menu.project.msaa.x2Normal (MSAAx2)-
!nanoem.menu.project.msaa.disabledDisabled9
nanoem.menu.project.msaa.titleAntialias ConfigurationG
5nanoem.menu.project.physics-simulation.enable.anytimeEnable AnytimeL
5nanoem.menu.project.physics-simulation.enable.playingEnable Only PlayingM
5nanoem.menu.project.physics-simulation.enable.tracingEnable as Trace Mode;
/nanoem.menu.project.physics-simulation.disabledDisabledE
4nanoem.menu.project.physics-simulation.configurationConfigurationE
+nanoem.menu.project.physics-simulation.bakeBake All Model MotionsP
,nanoem.menu.project.physics-simulation.bake2 Bake All Model Motions (with IK)L
;nanoem.menu.project.physics-simulation.enable.drawing.titleDebug DrawingL
?nanoem.menu.project.physics-simulation.enable.drawing.wireframe	WireframeB
:nanoem.menu.project.physics-simulation.enable.drawing.aabbAABBV
Dnanoem.menu.project.physics-simulation.enable.drawing.contact-pointsContact PointsP
Ananoem.menu.project.physics-simulation.enable.drawing.constraintsConstraintsZ
Fnanoem.menu.project.physics-simulation.enable.drawing.constraint-limitConstraint LimitB
,nanoem.menu.project.physics-simulation.titlePhysics Simulation.
!nanoem.menu.project.fps.unlimited	Unlimited#
nanoem.menu.project.fps.6060FPS#
nanoem.menu.project.fps.3030FPS3
nanoem.menu.project.fps.titlePlaying Frame Rate5
nanoem.menu.project.clear.audioClear Audio Source9
nanoem.menu.project.clear.videoClear Background VideoG
&nanoem.menu.project.enable.fps-counterEnable Displaying FPS CounterW
.nanoem.menu.project.enable.performance-monitor%Enable Displaying Performance Monitor/
nanoem.menu.camera.toggleToggle Camera Mode$
nanoem.menu.camera.preset.topTop&
nanoem.menu.camera.preset.leftLeft(
nanoem.menu.camera.preset.rightRight*
...
(nanoem.menu.model.select.morph.lip.titleLip3
...
nanoem.menu.model.reset.bone.xReset Translation of X-Axis=
nanoem.menu.model.reset.bone.yReset Translation of Y-Axis=
nanoem.menu.model.reset.bone.zReset Translation of Z-Axis=
...
2nanoem.menu.model.preference.enable.show-all-bonesShow All BonesJ
5nanoem.menu.model.preference.enable.show-rigid-bodiesShow Rigid Bodies>
/nanoem.menu.model.preference.enable.show-jointsShow JointsJ
5nanoem.menu.model.preference.enable.show-vertex-facesShow Vertex FacesL
...
nanoem.menu.edit.bone.biasOpen Bias Dialog>
!nanoem.menu.edit.camera.parameterOpen Numeric Input Dialog2
#nanoem.menu.edit.camera.reset-angleReset Angle<
"nanoem.menu.edit.camera.correctionOpen Correction Dialog;
!nanoem.menu.edit.morph.correctionOpen Correction DialogK
/nanoem.menu.edit.morph.remove-all-keyframes.lipRemove All Lip KeyframesK
/nanoem.menu.edit.morph.remove-all-keyframes.eyeRemove All Eye KeyframesS
3nanoem.menu.edit.morph.remove-all-keyframes.eyebrowRemove All Eyebrow Keyframes;
...
nanoem.menu.macos.quitQuit nanoem-
!nanoem.menu.macos.window.minimizeMinimize%
nanoem.menu.macos.window.zoomZoomA
+nanoem.menu.macos.window.bring-all-to-frontBring All to Front%
...
/nanoem.error.convert-to-nmm.recovery-suggestionHSee "Application Menu" > "Save" in "nanoem Online Manual" from Help MenuU
 ...
 nanoem.error.project.save.reason<Failed to save the project due to try saving incomplete datar
-nanoem.error.project.save.recovery-suggestionARetry saving the project after checking the destination is normalc
0nanoem.error.plugin.model.no-active-model.reason/The model is not selected to execute the pluginX
=nanoem.error.plugin.model.no-active-model.recovery-suggestionTry selecting the modelU
...
/nanoem.error.motion.not-camera-and-light.reason3The loading motion is not intended for camera/lightl
...
nanoem.status.ERROR_NULL_OBJECTNull object is referred/
nanoem.status.ERROR_BUFFER_ENDBuffer is endS
0nanoem.status.ERROR_DECODE_UNICODE_STRING_FAILEDFailed to decode Unicode stringS
0nanoem.status.ERROR_ENCODE_UNICODE_STRING_FAILEDFailed to encode Unicode string:
%nanoem.status.ERROR_INVALID_SIGNATUREInvalid signatureF
*nanoem.status.ERROR_MODEL_VERTEX_CORRUPTEDVertex data is corruptedL
(nanoem.status.ERROR_MODEL_FACE_CORRUPTED Face (Indices) data is corruptedJ
,nanoem.status.ERROR_MODEL_MATERIAL_CORRUPTEDMaterial data is corruptedB
(nanoem.status.ERROR_MODEL_BONE_CORRUPTEDBone data is corruptedQ
.nanoem.status.ERROR_MODEL_CONSTRAINT_CORRUPTEDIK Constraint data is corruptedR
+nanoem.status.ERROR_MODEL_TEXTURE_CORRUPTED#Texture reference data is corruptedD
)nanoem.status.ERROR_MODEL_MORPH_CORRUPTEDMorph data is corruptedD
)nanoem.status.ERROR_MODEL_LABEL_CORRUPTEDLabel data is corruptedN
.nanoem.status.ERROR_MODEL_RIGID_BODY_CORRUPTEDRigid body data is corruptedD
)nanoem.status.ERROR_MODEL_JOINT_CORRUPTEDJoint data is corruptedJ
)nanoem.status.ERROR_PMD_ENGLISH_CORRUPTEDPMD English data is corruptedD
'nanoem.status.ERROR_PMX_INFO_CORRUPUTEDPMX Metadata is corruptedT
2nanoem.status.ERROR_MOTION_BONE_KEYFRAME_CORRUPTEDThe bone keyframe is corrupted]
4nanoem.status.ERROR_MOTION_CAMERA_KEYFRAME_CORRUPTED%The camera keyframe data is corrupted[
3nanoem.status.ERROR_MOTION_LIGHT_KEYFRAME_CORRUPTED$The light keyframe data is corrupted[
3nanoem.status.ERROR_MOTION_MODEL_KEYFRAME_CORRUPTED$The model keyframe data is corrupted[
3nanoem.status.ERROR_MOTION_MORPH_KEYFRAME_CORRUPTED$The morph keyframe data is corruptedc
9nanoem.status.ERROR_MOTION_SELF_SHADOW_KEYFRAME_CORRUPTED&Self Shadow keyframe data is corrupted[
7nanoem.status.ERROR_MOTION_BONE_KEYFRAME_ALREADY_EXISTS The bone keyframe already existsT
2nanoem.status.ERROR_MOTION_BONE_KEYFRAME_NOT_FOUNDThe bone keyframe is not found_
9nanoem.status.ERROR_MOTION_CAMERA_KEYFRAME_ALREADY_EXISTS"The camera keyframe already existsX
4nanoem.status.ERROR_MOTION_CAMERA_KEYFRAME_NOT_FOUND The camera keyframe is not found]
8nanoem.status.ERROR_MOTION_LIGHT_KEYFRAME_ALREADY_EXISTS!The light keyframe already existsV
3nanoem.status.ERROR_MOTION_LIGHT_KEYFRAME_NOT_FOUNDThe light keyframe is not foundT
/nanoem.status.ERROR_MOTION_FRAME_ALREADY_EXISTS!The model keyframe already existsV
3nanoem.status.ERROR_MOTION_MODEL_KEYFRAME_NOT_FOUNDThe model keyframe is not found]
8nanoem.status.ERROR_MOTION_MORPH_KEYFRAME_ALREADY_EXISTS!The morph keyframe already existsV
3nanoem.status.ERROR_MOTION_MORPH_KEYFRAME_NOT_FOUNDThe morph keyframe is not foundi
>nanoem.status.ERROR_MOTION_SELF_SHADOW_KEYFRAME_ALREADY_EXISTS'The self shadow keyframe already existsb
9nanoem.status.ERROR_MOTION_SELF_SHADOW_KEYFRAME_NOT_FOUND%The self shadow keyframe is not founde
<nanoem.status.ERROR_MOTION_ACCESSORY_KEYFRAME_ALREADY_EXISTS%The accessory keyframe already exists^
7nanoem.status.ERROR_MOTION_ACCESSORY_KEYFRAME_NOT_FOUND#The accessory keyframe is not foundc
3nanoem.status.ERROR_EFFECT_PARAMETER_ALREADY_EXISTS,The effect parameter keyframe already exists\
.nanoem.status.ERROR_EFFECT_PARAMETER_NOT_FOUND*The effect parameter keyframe is not foundW
9nanoem.status.ERROR_MODEL_CONSTRAINT_STATE_ALREADY_EXISTSIK keyframe already existsM
4nanoem.status.ERROR_MODEL_CONSTRAINT_STATE_NOT_FOUNDIK keyframe not found`
0nanoem.status.ERROR_MODEL_BINDING_ALREADY_EXISTS,Outside parent model keyframe already existsY
+nanoem.status.ERROR_MODEL_BINDING_NOT_FOUND*Outside parent model keyframe is not foundM
/nanoem.status.ERROR_MODEL_VERTEX_ALREADY_EXISTSVertex data already existsF
*nanoem.status.ERROR_MODEL_VERTEX_NOT_FOUNDVertex data is not foundQ
1nanoem.status.ERROR_MODEL_MATERIAL_ALREADY_EXISTSMaterial data already existsJ
,nanoem.status.ERROR_MODEL_MATERIAL_NOT_FOUNDMaterial data is not foundG
-nanoem.status.ERROR_MODEL_BONE_ALREADY_EXISTSBone data is not foundB
(nanoem.status.ERROR_MODEL_BONE_NOT_FOUNDBone data is not foundV
3nanoem.status.ERROR_MODEL_CONSTRAINT_ALREADY_EXISTSIK constraint data is not foundQ
.nanoem.status.ERROR_MODEL_CONSTRAINT_NOT_FOUNDIK constraint data is not foundb
4nanoem.status.ERROR_MODEL_CONSTRAINT_JOINT_NOT_FOUND*IK constraint joint bone data is not foundY
0nanoem.status.ERROR_MODEL_TEXTURE_ALREADY_EXISTS%Texture reference data already existsR
+nanoem.status.ERROR_MODEL_TEXTURE_NOT_FOUND#Texture reference data is not foundK
.nanoem.status.ERROR_MODEL_MORPH_ALREADY_EXISTSMorph data already existsD
)nanoem.status.ERROR_MODEL_MORPH_NOT_FOUNDMorph data is not foundJ
-nanoem.status.ERROR_MODEL_MORPH_TYPE_MISMATCHMorph type is not matchedN
.nanoem.status.ERROR_MODEL_MORPH_BONE_NOT_FOUNDMorph bone data is not foundN
.nanoem.status.ERROR_MODEL_MORPH_FLIP_NOT_FOUNDMorph flip data is not foundP
/nanoem.status.ERROR_MODEL_MORPH_GROUP_NOT_FOUNDMorph group data is not foundT
1nanoem.status.ERROR_MODEL_MORPH_IMPULSE_NOT_FOUNDMorph impulse data is not foundV
2nanoem.status.ERROR_MODEL_MORPH_MATERIAL_NOT_FOUND Morph material data is not foundJ
,nanoem.status.ERROR_MODEL_MORPH_UV_NOT_FOUNDMorph UV data is not foundR
0nanoem.status.ERROR_MODEL_MORPH_VERTEX_NOT_FOUNDMorph vertex data is not foundK
.nanoem.status.ERROR_MODEL_LABEL_ALREADY_EXISTSLabel data already existsD
)nanoem.status.ERROR_MODEL_LABEL_NOT_FOUNDLabel data is not foundN
.nanoem.status.ERROR_MODEL_LABEL_ITEM_NOT_FOUNDLabel item data is not foundU
3nanoem.status.ERROR_MODEL_RIGID_BODY_ALREADY_EXISTSRigid body data already existsN
.nanoem.status.ERROR_MODEL_RIGID_BODY_NOT_FOUNDRigid body data is not foundK
.nanoem.status.ERROR_MODEL_JOINT_ALREADY_EXISTSJoint data already existsD
)nanoem.status.ERROR_MODEL_JOINT_NOT_FOUNDJoint data is not foundN
.nanoem.status.ERROR_MODEL_VERSION_INCOMPATIBLEMoel version is incompatibleV
5nanoem.status.ERROR_DOCUMENT_ACCESSORY_ALREADY_EXISTSAccessory data already existsO
0nanoem.status.ERROR_DOCUMENT_ACCESSORY_NOT_FOUNDAccessory data is not foundg
>nanoem.status.ERROR_DOCUMENT_ACCESSORY_KEYFRAME_ALREADY_EXISTS%The accessory keyframe already exists`
9nanoem.status.ERROR_DOCUMENT_ACCESSORY_KEYFRAME_NOT_FOUND#The accessory keyframe is not founda
;nanoem.status.ERROR_DOCUMENT_CAMERA_KEYFRAME_ALREADY_EXISTS"The camera keyframe already existsZ
6nanoem.status.ERROR_DOCUMENT_CAMERA_KEYFRAME_NOT_FOUND The camera keyframe is not foundn
<nanoem.status.ERROR_DOCUMENT_GRAVITY_KEYFRAME_ALREADY_EXISTS.The physics simulation keyframe already existsg
7nanoem.status.ERROR_DOCUMENT_GRAVITY_KEYFRAME_NOT_FOUND,The physics simulation keyframe is not found_
:nanoem.status.ERROR_DOCUMENT_LIGHT_KEYFRAME_ALREADY_EXISTS!The light keyframe already existsX
5nanoem.status.ERROR_DOCUMENT_LIGHT_KEYFRAME_NOT_FOUNDThe light keyframe is not foundN
1nanoem.status.ERROR_DOCUMENT_MODEL_ALREADY_EXISTSModel data already existsG
,nanoem.status.ERROR_DOCUMENT_MODEL_NOT_FOUNDModel data is not foundc
?nanoem.status.ERROR_DOCUMENT_MODEL_BONE_KEYFRAME_ALREADY_EXISTS The bone keyframe already exists\
:nanoem.status.ERROR_DOCUMENT_MODEL_BONE_KEYFRAME_NOT_FOUNDThe bone keyframe is not foundY
<nanoem.status.ERROR_DOCUMENT_MODEL_BONE_STATE_ALREADY_EXISTSBone state already existsR
7nanoem.status.ERROR_DOCUMENT_MODEL_BONE_STATE_NOT_FOUNDBone state is not foundh
Bnanoem.status.ERROR_DOCUMENT_MODEL_CONSTRAINT_STATE_ALREADY_EXISTS"IK constraint state already existsa
=nanoem.status.ERROR_DOCUMENT_MODEL_CONSTRAINT_STATE_NOT_FOUND IK constraint state is not founde
@nanoem.status.ERROR_DOCUMENT_MODEL_MODEL_KEYFRAME_ALREADY_EXISTS!The model keyframe already exists^
;nanoem.status.ERROR_DOCUMENT_MODEL_MODEL_KEYFRAME_NOT_FOUNDThe model keyframe is not founde
@nanoem.status.ERROR_DOCUMENT_MODEL_MORPH_KEYFRAME_ALREADY_EXISTS!The morph keyframe already exists^
;nanoem.status.ERROR_DOCUMENT_MODEL_MORPH_KEYFRAME_NOT_FOUNDThe morph keyframe is not found[
=nanoem.status.ERROR_DOCUMENT_MODEL_MORPH_STATE_ALREADY_EXISTSMorph state already existsT
8nanoem.status.ERROR_DOCUMENT_MODEL_MORPH_STATE_NOT_FOUNDMorph state is not foundg
@nanoem.status.ERROR_DOCUMENT_MODEL_OUTSIDE_PARENT_ALREADY_EXISTS#Model outside parent already exists`
;nanoem.status.ERROR_DOCUMENT_MODEL_OUTSIDE_PARENT_NOT_FOUND!Model outside parent is not founds
Fnanoem.status.ERROR_DOCUMENT_MODEL_OUTSIDE_PARENT_STATE_ALREADY_EXISTS)Model outside parent state already existsl
Ananoem.status.ERROR_DOCUMENT_MODEL_OUTSIDE_PARENT_STATE_NOT_FOUND'Model outside parent state is not foundk
@nanoem.status.ERROR_DOCUMENT_SELF_SHADOW_KEYFRAME_ALREADY_EXISTS'The self shadow keyframe already existsd
;nanoem.status.ERROR_DOCUMENT_SELF_SHADOW_KEYFRAME_NOT_FOUND%The self shadow keyframe is not foundO
0nanoem.status.ERROR_DOCUMENT_ACCESSORY_CORRUPTEDAccessory data is corrupted`
9nanoem.status.ERROR_DOCUMENT_ACCESSORY_KEYFRAME_CORRUPTED#The accessory keyframe is corruptedl
?nanoem.status.ERROR_DOCUMENT_ACCESSORY_OUTSIDE_PARENT_CORRUPTED)The accessory outside parent is corruptedI
-nanoem.status.ERROR_DOCUMENT_CAMERA_CORRUPTEDCamera data is corruptedZ
6nanoem.status.ERROR_DOCUMENT_CAMERA_KEYFRAME_CORRUPTED The camera keyframe is corruptedV
.nanoem.status.ERROR_DOCUMENT_GRAVITY_CORRUPTED$Physics simulation data is corruptedg
7nanoem.status.ERROR_DOCUMENT_GRAVITY_KEYFRAME_CORRUPTED,The physics simulation keyframe is corruptedG
,nanoem.status.ERROR_DOCUMENT_LIGHT_CORRUPTEDLight data is corruptedX
5nanoem.status.ERROR_DOCUMENT_LIGHT_KEYFRAME_CORRUPTEDThe light keyframe is corruptedG
,nanoem.status.ERROR_DOCUMENT_MODEL_CORRUPTEDModel data is corruptedX
5nanoem.status.ERROR_DOCUMENT_MODEL_KEYFRAME_CORRUPTEDThe model keyframe is corrupted\
:nanoem.status.ERROR_DOCUMENT_MODEL_BONE_KEYFRAME_CORRUPTEDThe bone keyframe is corruptedV
7nanoem.status.ERROR_DOCUMENT_MODEL_BONE_STATE_CORRUPTEDThe bone state is corruptede
=nanoem.status.ERROR_DOCUMENT_MODEL_CONSTRAINT_STATE_CORRUPTED$The IK constraint state is corrupted^
;nanoem.status.ERROR_DOCUMENT_MODEL_MORPH_KEYFRAME_CORRUPTEDThe morph keyframe is corruptedX
8nanoem.status.ERROR_DOCUMENT_MODEL_MORPH_STATE_CORRUPTEDThe morph state is corruptedd
