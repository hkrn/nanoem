...
TEST_CASE("project_shift_all_motion_keyframes_backward", "[emapp][project]")
{
    TestScope scope;
    Error error;
    ...
    SECTION("camera")
    {
        ...
        CHECK_FALSE(motion->findCameraKeyframe(1335));
        CHECK(motion->findCameraKeyframe(1336));
        CHECK_FALSE(motion->findCameraKeyframe(1337));
        CHECK(motion->findCameraKeyframe(1338));
        CHECK(motion->findCameraKeyframe(1339));
        CHECK_FALSE(motion->findCameraKeyframe(1340));
        CHECK(motion->duration() == 1339);
        project->handleUndoAction();
        CHECK_FALSE(motion->findCameraKeyframe(1335));
        CHECK(motion->findCameraKeyframe(1336));
        CHECK(motion->findCameraKeyframe(1337));
    ...
    SECTION("light")
    {
        ...
        CHECK_FALSE(motion->findLightKeyframe(1337));
        CHECK(motion->findLightKeyframe(1338));
        CHECK(motion->findLightKeyframe(1339));
        CHECK_FALSE(motion->findLightKeyframe(1340));
        CHECK(motion->duration() == 1339);
        project->handleUndoAction();
        CHECK_FALSE(motion->findLightKeyframe(1335));
        CHECK(motion->findLightKeyframe(1336));
    ...
    SECTION("selfshadow")
    {
        ...
        CHECK_FALSE(motion->findSelfShadowKeyframe(1337));
        CHECK(motion->findSelfShadowKeyframe(1338));
        CHECK(motion->findSelfShadowKeyframe(1339));
        CHECK_FALSE(motion->findSelfShadowKeyframe(1340));
        CHECK(motion->duration() == 1339);
        project->handleUndoAction();
        CHECK_FALSE(motion->findSelfShadowKeyframe(1335));
        CHECK(motion->findSelfShadowKeyframe(1336));
    ...
    SECTION("accessory")
    {
        ...
        CHECK_FALSE(motion->findAccessoryKeyframe(1337));
        CHECK(motion->findAccessoryKeyframe(1338));
        CHECK(motion->findAccessoryKeyframe(1339));
        CHECK_FALSE(motion->findAccessoryKeyframe(1340));
        CHECK(motion->duration() == 1339);
        project->handleUndoAction();
        CHECK_FALSE(motion->findAccessoryKeyframe(1335));
        CHECK(motion->findAccessoryKeyframe(1336));
    ...
    SECTION("bone")
    {
        ...
        CHECK_FALSE(motion->findBoneKeyframe(name, 1337));
        CHECK(motion->findBoneKeyframe(name, 1338));
        CHECK(motion->findBoneKeyframe(name, 1339));
        CHECK_FALSE(motion->findBoneKeyframe(name, 1340));
        CHECK(motion->duration() == 1339);
        project->handleUndoAction();
        CHECK_FALSE(motion->findBoneKeyframe(name, 1335));
        CHECK(motion->findBoneKeyframe(name, 1336));
    ...
    SECTION("model")
    {
        ...
        CHECK_FALSE(motion->findModelKeyframe(1337));
        CHECK(motion->findModelKeyframe(1338));
        CHECK(motion->findModelKeyframe(1339));
        CHECK_FALSE(motion->findModelKeyframe(1340));
        CHECK(motion->duration() == 1339);
        project->handleUndoAction();
        CHECK_FALSE(motion->findModelKeyframe(1335));
        CHECK(motion->findModelKeyframe(1336));
    ...
    SECTION("morph")
    {
        ...
        CHECK_FALSE(motion->findMorphKeyframe(name, 1337));
        CHECK(motion->findMorphKeyframe(name, 1338));
        CHECK(motion->findMorphKeyframe(name, 1339));
        CHECK_FALSE(motion->findMorphKeyframe(name, 1340));
        CHECK(motion->duration() == 1339);
        project->handleUndoAction();
        CHECK_FALSE(motion->findMorphKeyframe(name, 1335));
        CHECK(motion->findMorphKeyframe(name, 1336));
...
TEST_CASE("project_shift_all_motion_keyframes_backward_redo", "[emapp][project]")
{
    TestScope scope;
    Error error;
    ProjectPtr first = scope.createProject();
...
TEST_CASE("project_shift_all_motion_keyframes_backward_after_remove", "[emapp][project]")
{
    TestScope scope;
    Error error;
    ProjectPtr first = scope.createProject();
