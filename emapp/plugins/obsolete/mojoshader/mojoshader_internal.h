...
void MOJOSHADER_runPreshader(const MOJOSHADER_preshader*, nanoem_f32_t*);
#endif
...
// Locale-independent nanoem_f32_t printing replacement for snprintf
size_t MOJOSHADER_printFloat(char *text, size_t maxlen, nanoem_f32_t arg);
...
typedef unsigned __int8 nanoem_u8;
typedef unsigned __int16 nanoem_u16;
typedef unsigned __int32 nanoem_u32;
typedef unsigned __int64 nanoem_u64;
typedef __int32 nanoem_i32;
typedef __int64 nanoem_i64;
#ifdef _WIN64
...
#else
#include <stdint.h>
typedef nanoem_u8_t nanoem_u8;
typedef nanoem_u16_t nanoem_u16;
typedef nanoem_u32_t nanoem_u32;
typedef nanoem_i32_t nanoem_i32;
typedef nanoem_i64_t nanoem_i64;
typedef nanoem_u64_t nanoem_u64;
#endif
...
// Byteswap magic...
    ...
    static inline nanoem_u32 SWAP32(nanoem_u32 x)
    {
        __asm__ __volatile__("lwbrx %0,0,%1" : "=r" (x) : "r" (&x));
        return x;
    } // SWAP32
    static inline nanoem_u16 SWAP16(nanoem_u16 x)
    {
...
typedef nanoem_u32 (*HashTable_HashFn)(const void *key, void *data);
...
nanoem_u32 hash_hash_string(const void *sym, void *unused);
...
typedef struct
{
    const nanoem_u32 *token;   // this is the unmolested token in the stream.
    int regnum;
    int relative;
