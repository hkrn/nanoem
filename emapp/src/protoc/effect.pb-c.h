...
typedef struct _Fx9__Effect__Uniform Fx9__Effect__Uniform;
typedef struct _Fx9__Effect__SamplerState Fx9__Effect__SamplerState;
typedef struct _Fx9__Effect__Sampler Fx9__Effect__Sampler;
typedef struct _Fx9__Effect__Attribute Fx9__Effect__Attribute;
typedef struct _Fx9__Effect__Symbol Fx9__Effect__Symbol;
typedef struct _Fx9__Effect__RenderState Fx9__Effect__RenderState;
typedef struct _Fx9__Effect__Texture Fx9__Effect__Texture;
typedef struct _Fx9__Effect__Shader Fx9__Effect__Shader;
typedef struct _Fx9__Effect__Metadata Fx9__Effect__Metadata;
typedef struct _Fx9__Effect__Vector4i Fx9__Effect__Vector4i;
typedef struct _Fx9__Effect__Vector4f Fx9__Effect__Vector4f;
typedef struct _Fx9__Effect__Parameter Fx9__Effect__Parameter;
typedef struct _Fx9__Effect__Annotation Fx9__Effect__Annotation;
typedef struct _Fx9__Effect__Pass Fx9__Effect__Pass;
typedef struct _Fx9__Effect__Technique Fx9__Effect__Technique;
typedef struct _Fx9__Effect__Include Fx9__Effect__Include;
typedef struct _Fx9__Effect__Effect Fx9__Effect__Effect;
...
struct  _Fx9__Effect__SamplerState
{
  ProtobufCMessage base;
  uint32_t key;
  uint32_t value;
...
struct  _Fx9__Effect__Attribute
{
  ProtobufCMessage base;
...
struct  _Fx9__Effect__RenderState
{
  ProtobufCMessage base;
  uint32_t key;
  uint32_t value;
...
typedef enum {
  ...
  FX9__EFFECT__SHADER__BODY_SPIRV = 11
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FX9__EFFECT__SHADER__BODY)
} Fx9__Effect__Shader__BodyCase;

struct  _Fx9__Effect__Shader
{
  ProtobufCMessage base;
...
typedef enum {
  ...
  FX9__EFFECT__PARAMETER__CLASS_CLASS_DX9MS = 9
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FX9__EFFECT__PARAMETER__CLASS)
} Fx9__Effect__Parameter__ClassCase;

typedef enum {
  FX9__EFFECT__PARAMETER__TYPE__NOT_SET = 0,
  FX9__EFFECT__PARAMETER__TYPE_TYPE_DX9MS = 10
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FX9__EFFECT__PARAMETER__TYPE)
} Fx9__Effect__Parameter__TypeCase;

struct  _Fx9__Effect__Parameter
{
  ProtobufCMessage base;
  char *name;
  char *semantic;
...
typedef enum {
  ...
  FX9__EFFECT__ANNOTATION__VALUE_FVAL4 = 7
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FX9__EFFECT__ANNOTATION__VALUE)
} Fx9__Effect__Annotation__ValueCase;

struct  _Fx9__Effect__Annotation
{
  ProtobufCMessage base;
  char *name;
...
typedef enum {
  ...
  FX9__EFFECT__PASS__IMPLEMENTATION_IMPLEMENTATION_DX9MS = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FX9__EFFECT__PASS__IMPLEMENTATION)
} Fx9__Effect__Pass__ImplementationCase;

struct  _Fx9__Effect__Pass
{
  ProtobufCMessage base;
  char *name;
  size_t n_annotations;
...
struct  _Fx9__Effect__Technique
{
  ProtobufCMessage base;
  char *name;
  size_t n_passes;
