...
typedef struct _Nanoem__Common__Annotation Nanoem__Common__Annotation;
typedef struct _Nanoem__Common__Vector3 Nanoem__Common__Vector3;
typedef struct _Nanoem__Common__Vector4 Nanoem__Common__Vector4;
typedef struct _Nanoem__Common__Color Nanoem__Common__Color;
typedef struct _Nanoem__Common__Quaternion Nanoem__Common__Quaternion;
typedef struct _Nanoem__Common__Interpolation Nanoem__Common__Interpolation;
typedef struct _Nanoem__Common__Point Nanoem__Common__Point;
typedef struct _Nanoem__Common__Size Nanoem__Common__Size;
typedef struct _Nanoem__Common__Rect Nanoem__Common__Rect;
typedef struct _Nanoem__Common__Rational Nanoem__Common__Rational;
...
struct  _Nanoem__Common__Annotation
{
...
struct  _Nanoem__Common__Vector3
{
  ProtobufCMessage base;
  float x;
  float y;
...
struct  _Nanoem__Common__Vector4
{
  ProtobufCMessage base;
  float x;
  float y;
...
struct  _Nanoem__Common__Quaternion
{
  ProtobufCMessage base;
  float x;
  float y;
...
struct  _Nanoem__Common__Rational
{
  ProtobufCMessage base;
