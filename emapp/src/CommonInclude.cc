...
PFN_sg_dealloc_buffer dealloc_buffer = nullptr;
PFN_sg_dealloc_image dealloc_image = nullptr;
PFN_sg_dealloc_shader dealloc_shader = nullptr;
PFN_sg_dealloc_pipeline dealloc_pipeline = nullptr;
PFN_sg_dealloc_pass dealloc_pass = nullptr;
...
PFN_sg_uninit_buffer uninit_buffer = nullptr;
PFN_sg_uninit_image uninit_image = nullptr;
PFN_sg_uninit_shader uninit_shader = nullptr;
PFN_sg_uninit_pipeline uninit_pipeline = nullptr;
PFN_sg_uninit_pass uninit_pass = nullptr;
...
openSharedLibrary(const char *dllPath)
{
    ...
    if (handle) {
        ...
        dealloc_buffer = reinterpret_cast<PFN_sg_dealloc_buffer>(bx::dlsym(handle, "sgx_dealloc_buffer"));
        dealloc_image = reinterpret_cast<PFN_sg_dealloc_image>(bx::dlsym(handle, "sgx_dealloc_image"));
        dealloc_shader = reinterpret_cast<PFN_sg_dealloc_shader>(bx::dlsym(handle, "sgx_dealloc_shader"));
        dealloc_pipeline = reinterpret_cast<PFN_sg_dealloc_pipeline>(bx::dlsym(handle, "sgx_dealloc_pipeline"));
        dealloc_pass = reinterpret_cast<PFN_sg_dealloc_pass>(bx::dlsym(handle, "sgx_dealloc_pass"));
        ...
        uninit_buffer = reinterpret_cast<PFN_sg_uninit_buffer>(bx::dlsym(handle, "sgx_uninit_buffer"));
        uninit_image = reinterpret_cast<PFN_sg_uninit_image>(bx::dlsym(handle, "sgx_uninit_image"));
        uninit_shader = reinterpret_cast<PFN_sg_uninit_shader>(bx::dlsym(handle, "sgx_uninit_shader"));
        uninit_pipeline = reinterpret_cast<PFN_sg_uninit_pipeline>(bx::dlsym(handle, "sgx_uninit_pipeline"));
        uninit_pass = reinterpret_cast<PFN_sg_uninit_pass>(bx::dlsym(handle, "sgx_uninit_pass"));
