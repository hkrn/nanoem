...
bool
ModelEditCommandDialog::drawGizmo(ImDrawList *drawList, const ImVec2 &offset, const ImVec2 &size, Project *project)
{
...
void
ModelEditCommandDialog::applyDeltaTransform(const Matrix4x4 &delta, Model *activeModel)
{
...
void
ModelEditCommandDialog::beforeToggleEditingMode(IModelObjectSelection::EditingType editingType, Model *activeModel, Project *project)
{
    switch (editingType) {
    case IModelObjectSelection::kEditingTypeVertex: {
...
void
ModelEditCommandDialog::afterToggleEditingMode(IModelObjectSelection::EditingType editingType, Model *activeModel, Project *project)
{
    switch (editingType) {
    case IModelObjectSelection::kEditingTypeVertex: {
