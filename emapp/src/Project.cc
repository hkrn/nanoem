...
Project::newModel(Error &error)
{
    ...
    StringUtils::format(desc.m_name[NANOEM_LANGUAGE_TYPE_SIMPLIFIED_CHINESE], "NewModel-%s", shortUUID);
    StringUtils::format(desc.m_name[NANOEM_LANGUAGE_TYPE_TRADITIONAL_CHINESE], "NewModel-%s", shortUUID);
