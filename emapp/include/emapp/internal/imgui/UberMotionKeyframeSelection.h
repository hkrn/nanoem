...
#pragma once
#ifndef NANOEM_EMAPP_INTERNAL_IMGUI_UBERMOTIONKEYFRAMESELECTION_H_
#define NANOEM_EMAPP_INTERNAL_IMGUI_UBERMOTIONKEYFRAMESELECTION_H_
...
class UberMotionKeyframeSelection final : public IMotionKeyframeSelection {
public:
    UberMotionKeyframeSelection();
    ~UberMotionKeyframeSelection() NANOEM_DECL_NOEXCEPT;
    ...
    void addBoneKeyframes(const nanoem_model_bone_t * /* bone */, nanoem_frame_index_t /* start */,
        nanoem_frame_index_t /* end */) NANOEM_DECL_OVERRIDE;
    ...
    void addMorphKeyframes(const nanoem_model_morph_t * /* morph */, nanoem_frame_index_t /* start */,
        nanoem_frame_index_t /* end */) NANOEM_DECL_OVERRIDE;
...
#endif /* NANOEM_EMAPP_INTERNAL_IMGUI_UBERMOTIONKEYFRAMESELECTION_H_ */
