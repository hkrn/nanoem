...
#pragma once
#ifndef NANOEM_EMAPP_INTERNAL_IMGUI_LAZYPUBLISHCANCOPYEVENTCOMMAND_H_
#define NANOEM_EMAPP_INTERNAL_IMGUI_LAZYPUBLISHCANCOPYEVENTCOMMAND_H_
...
#endif /* NANOEM_EMAPP_INTERNAL_IMGUI_LAZYPUBLISHCANCOPYEVENTCOMMAND_H_ */
