...
NANOEM_DECL_ENUM(
    int, nanoem_application_plugin_effect_option_t) { NANOEM_APPLICATION_PLUGIN_EFFECT_OPTION_UNKNOWN = -1, ///< Unknown
    NANOEM_APPLICATION_PLUGIN_EFFECT_OPTION_FIRST_ENUM,
    NANOEM_APPLICATION_PLUGIN_EFFECT_OPTION_SHADER_VERSION =
        NANOEM_APPLICATION_PLUGIN_EFFECT_OPTION_FIRST_ENUM, ///< Setting shader version (u32)
