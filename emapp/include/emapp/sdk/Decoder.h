...
NANOEM_DECL_ENUM(int,
    nanoem_application_plugin_decoder_option_t) { NANOEM_APPLICATION_PLUGIN_DECODER_OPTION_UNKNOWN = -1, ///< Unknown
    NANOEM_APPLICATION_PLUGIN_DECODER_OPTION_FIRST_ENUM,
    NANOEM_APPLICATION_PLUGIN_DECODER_OPTION_FPS =
        NANOEM_APPLICATION_PLUGIN_DECODER_OPTION_FIRST_ENUM, ///< Setting FPS value (u32)
...
NANOEM_DECL_ENUM(int,
    ...
    NANOEM_APPLICATION_PLUGIN_DECODER_AUDIO_FORMAT_NUM_BITS =
        NANOEM_APPLICATION_PLUGIN_DECODER_OPTION_FIRST_ENUM, ///< Getting decode audio number of bits (u32)
...
NANOEM_DECL_ENUM(int,
    ...
    NANOEM_APPLICATION_PLUGIN_DECODER_VIDEO_FORMAT_WIDTH =
        NANOEM_APPLICATION_PLUGIN_DECODER_OPTION_FIRST_ENUM, ///< Getting decode video width (u32)
